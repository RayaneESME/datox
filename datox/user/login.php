...
<head>
    ...
    <!-- <link rel="stylesheet" class="skin-css" type="text/css" href="assets/css/skin/skin-2.css"> -->
...
<body class="bg-white"  data-theme-color="color-primary-2">
    ...
    <!-- Preloader end-->
    <form method="POST" enctype="multipart/form-data" action="welcome-policy.php">
    <!-- Page Content -->
		...
		<div class="container">
			<div class="account-area style-2">
				...
				<div class="section-head ps-0">
					<h2>Quel est votre numéro ?</h2>
				</div>
				<div class="input-group dz-select">
					<div class="input-group-text"> 
						<div>
							<select class="form-control custom-image-select image-select" name="countryCode">
								<option data-thumbnail="assets/images/flags/france.png">+33</option>
							</select>
						</div>
					</div>
					<input type="number" name="phone" class="form-control" placeholder="00 0000 0000">
				</div>
			</div>
        </div>
    </div>
    ...
    <div class="footer fixed bg-white p-b15">
		<div class="container">
			<button type="submit" name="submitPhone" class="btn btn-lg btn-gradient w-100 dz-flex-box btn-shadow rounded-xl">Suivant</button>
