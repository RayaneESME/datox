...
<div class="page-wrapper">
    ...
    <!-- Preloader end-->
    <form method="POST" enctype="multipart/form-data" action="you-into.php">
    <!-- Page Content -->
				...
				<div class="radio style-4 row g-2">
					<div class="col-4">
						<label class="radio-label">
							<input type="radio" name="lookfor" value="Sérieux">
					...
					<div class="col-4">
						<label class="radio-label">
							<input type="radio" name="lookfor" value="Il faut voir">
							<span class="checkmark">
					...
					<div class="col-4">
						<label class="radio-label">
							<input type="radio" name="lookfor" value="Libre">
							<span class="checkmark">
					...
					<div class="col-4">
						<label class="radio-label">
							<input type="radio" name="lookfor" value="Fun">
							<span class="checkmark">
					...
					<div class="col-4">
						<label class="radio-label">
							<input type="radio" name="lookfor" value="Amis">
							<span class="checkmark">
					...
					<div class="col-4">
						<label class="radio-label">
							<input type="radio" name="lookfor" value="Indécis">
							<span class="checkmark">
    ...
    <div class="footer fixed bg-white p-b15">
		<div class="container">
			<button type="submit" name="submitlookfor" class="btn btn-lg btn-gradient w-100 dz-flex-box btn-shadow rounded-xl">Suivant</button>
		</div>
	</div>
	<!-- Footer -->
	</form>
