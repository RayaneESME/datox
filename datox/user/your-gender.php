...
<div class="page-wrapper">
    ...
    <!-- Preloader end-->
    <form method="POST" enctype="multipart/form-data" action="orientation.php">
    ...
    <div class="footer fixed bg-white p-b15">
		<div class="container">
			...
			<button type="submit" name="submitGender" class="btn btn-lg btn-gradient w-100 dz-flex-box btn-shadow rounded-xl">Suivant</button>
		</div>
	</div>
	<!-- Footer -->
	 </form>
