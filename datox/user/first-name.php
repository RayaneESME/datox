...
<div class="page-wrapper">
		...
		<div class="container">
			<div class="account-area style-2">
				...
				<div class="mb-2 input-group input-group-icon input-mini">
					...
					<input type="text" name="fullName" class="form-control" placeholder="Votre prénom" required>								
				</div>
			</div>
        </div>
    </div>
    ...
    <div class="footer fixed bg-white p-b15">
		<div class="container">
			<button type="submit" name="submitName" class="btn btn-lg btn-gradient w-100 dz-flex-box btn-shadow rounded-xl">Suivant</button>
