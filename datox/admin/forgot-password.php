...
if (isset($_POST['sendEmail'])) {
    ...
    $query = "UPDATE admin_login SET reset_token = '$token' WHERE email = '$email'";
    mysqli_query($connect, $query);

    $reset_link = "http://localhost/datox/admin/reset-password.php?token=$token&email=$email";
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="sendEmail" value="Reset Password" class="btn btn-primary d-grid w-100">Send Reset Link</button>
              </form>
